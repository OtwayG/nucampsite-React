...
class CommentForm extends Component {
    ...
    render() {
        return (<>
            <Button color="primary" className="fa fa-lg fa-pencil" outline onClick={this.toggleModal}> Submit Comment</Button>
                ...
                <ModalBody>
                    <LocalForm onSubmit={values => this.handleSubmit(values)}>
                        ...
                        <div className="form-grou">
                            <Button className='fa fa-comment' type="submit" value="submit" color="primary">Submit Comment Here</Button>
                        </div>
                    </LocalForm>
                </ModalBody>
            </Modal>
